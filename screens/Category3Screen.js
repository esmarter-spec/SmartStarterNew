...
export default function Category3Screen({ navigation }) {
  ...
  // 💬 Shake animation for bubble & navigation buttons
  ...
  // 🐾 Bounce animation for animals image
  ...
  const handleNextPress = () => navigation.navigate('Category4');
      ...
      <View style={styles.container}>
        ...
        >
          <Image
            ...
            resizeMode="contain"
          />
          <Text style={styles.bubbleText}>10/100{'\n'}Cards</Text>
        </Animated.View>

        {/* 🐾 Animals Image */}
        <Animated.View style={{ transform: [{ scale: animalScale }] }}>
