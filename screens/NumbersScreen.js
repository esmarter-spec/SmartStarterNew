...
export default function Numbers({ navigation }) {
  ...
  // 🫧 Floating bubble animation loop
  useEffect(() => {
    animations.forEach((anim) => {
      const loopAnimation = () => {
        ...
        Animated.timing(anim, {
          toValue: 1,
          duration: 8000 + Math.random() * 4000, // random speed
  ...
  const handleLearnPress = () => {
    navigation.navigate("NumberScreen"); // ✅ Updated target
  };

  // 🎮 Navigate to Play Screen
  const handlePlayPress = () => {
    navigation.navigate("PlayN");
  };
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.optionBox}>
            <Image
              source={require("../assets/learnN.png")}
        ...
        >
          <View style={styles.optionBox}>
            <Image
              source={require("../assets/playN.png")}
              style={styles.optionImage}
              resizeMode="contain"
            />
          </View>
